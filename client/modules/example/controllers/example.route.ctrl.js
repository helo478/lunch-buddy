(function() {
  angular.module('app.example').controller('exampleRouteCtrl', function($log, exampleService) {
    ...
    this.addExample = function() {
      $log.debug('Entering exampleRouteCtrl.addExample for example: ', self.newExample);
